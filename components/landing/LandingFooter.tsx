export function LandingFooter() {
  return (
    <footer className="bg-[var(--color-secondary)] text-gray-400">
      <div className="max-w-6xl mx-auto px-4 lg:px-8 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              Cardápio digital para restaurantes, lanchonetes e estabelecimentos alimentícios de todo o Brasil.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Começar grátis</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-sm">
          <span>© {new Date().getFullYear()} Fastmenu. Todos os direitos reservados.</span>
